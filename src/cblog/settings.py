...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/eyup/capstone/username')
    password_param = ssm.get_parameter(Name="/eyup/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ch4vsgrdcjhc.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneseyupblog' # please enter your s3 bucket name
